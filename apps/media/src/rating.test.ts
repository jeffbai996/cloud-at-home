...
describe("ratingBadge", () => {
  it.each([
    ...
    ["CA-R", { label: "R", scheme: "ca", shape: "octagon", tone: "red" }],
  ...
  it.each([
    ["CA-G", "General", "B.C. Film Classification Office", "Suitable for viewers of all ages."],
    ["CA-14A", "14 Accompaniment", "B.C. Film Classification Office", "Viewers under 14 years of age must be accompanied by an adult."],
    ["CA-18A", "18 Accompaniment", "B.C. Film Classification Office", "Viewers under 18 years of age must be accompanied by an adult."],
    ["CA-R", "Restricted", "B.C. Film Classification Office", "under 18 years of age are not permitted"],
    ["CA-A", "Adult", "B.C. Film Classification Office", "under 18 years of age are not permitted"],
